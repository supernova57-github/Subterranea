...
public class SBTRStructureRegistry {
	...
	public static final RegistryObject<StructureFeature<JigsawConfiguration>> MOUNTAIN_FORTRESS 
		= Subterranea.STRUCTURES.register("mountain_fortress", () -> new MountainFortressFeature(Reference.BIG_STRUCTURE_CODEC));
